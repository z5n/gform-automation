...
function submitForm() {
    ...
    const form = new Form('1FAIpQLSdQ_K8ulH6v1ep89-mi3uBP8NvdcTkZpW6Z2Xb1hzePqTzpHg') // Form id
...
/*    console.log(optionSelectorQuestion1)
    ...
    var randomMinute = 42 // randomMinute({ min: 18 });

    var randomSecond = 53 // randomSecond()
...
var log_file = fs.createWriteStream(__dirname + '/alt.log', {flags : 'w'});
